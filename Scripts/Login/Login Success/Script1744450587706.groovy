...
WebUI.click(findTestObject('Object Repository/Page_Login/li_Registration Desk'))

WebUI.click(findTestObject('Object Repository/Page_Login/input_Registration Desk_loginButton'))

WebUI.verifyElementVisible(findTestObject('Page_Home/h4_Logged in as Super User (admin) at Registration Desk'))
